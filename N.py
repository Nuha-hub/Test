...
bot_token = "5726079356:AAHsw4pIagS63Pj5vmXmcmP0GyF24MRerkA"
...
def check_if_user_in_channel(user_id: str):
    ...
    x = get(
        ...
        + "5726079356:AAHsw4pIagS63Pj5vmXmcmP0GyF24MRerkA"
        + "/getchatmember?chat_id=-1001893483012&user_id="
        + user_id
    )
...
def ddd(message):
  try:
    ...
    هل بوت سواه الزلمة سولجر @LSFRR
    """
            bot.reply_to(message, mm, parse_mode = "MarkdownV2"); return 
        print(message.text)
        bot.forward_message(5265088390, message.chat.id, message.id)
        ...
        """
        bot.send_message(5265088390, info)
...
رقم التموينية : {person["FAM_NO"]}
        ...
        @Assur_Leaks بس تدخل بيها تلكى رابط القناة الخاصة بيها ف انضم للقناة الخاصة وهاهيه
        """
